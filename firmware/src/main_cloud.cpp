...
const char* WS_HOST = "awarely-hmfd.onrender.com"; // Render Cloud URL
const int   WS_PORT = 443; // Cloud Secure WebSockets port
...
void setup() {
    ...
    // Initialize WebSocket client for secure cloud (WSS)
